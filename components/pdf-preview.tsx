...
export function PdfPreview({
  ...
  return (
    <div className="rounded-xl bg-muted/20 p-1.5">
      <div
        ref={containerRef}
        className={`flex w-full overflow-hidden rounded-lg bg-background [&_.react-pdf__Document]:flex [&_.react-pdf__Document]:h-full [&_.react-pdf__Document]:w-full [&_.react-pdf__Page]:flex [&_.react-pdf__Page]:h-full [&_.react-pdf__Page]:w-full [&_.react-pdf__Page]:justify-center [&_.react-pdf__Page__canvas]:h-auto [&_.react-pdf__Page__canvas]:w-auto [&_.react-pdf__Page__canvas]:max-w-full ${
          compact
            ? "h-40 items-start [&_.react-pdf__Page]:items-start [&_.react-pdf__Page__canvas]:max-h-none sm:h-44"
            : "aspect-[210/297] items-center [&_.react-pdf__Page]:items-center [&_.react-pdf__Page__canvas]:max-h-full"
        }`}
      >
